...
# Default target
default: prepare
	$(def_compiler) -o $(BUILD_DIR)/$(def_output_name) $(SRC_DIR)/* $(DEFAULT_FLAGS)

# Debug build
dbg: prepare
	$(def_compiler) $(DEBUG_FLAGS) $(DEFAULT_FLAGS) -o $(BUILD_DIR)/dbg_$(def_output_name) $(SRC_DIR)/*

# Release build
release: prepare
	$(def_compiler) $(RELEASE_FLAGS) $(DEFAULT_FLAGS) -o $(BUILD_DIR)/release_$(def_output_name) $(SRC_DIR)/*
